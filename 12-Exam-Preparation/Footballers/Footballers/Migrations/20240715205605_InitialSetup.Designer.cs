...
namespace Footballers.Migrations
{
    ...
    [Migration("20240715205605_InitialSetup")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Footballers.Data.Models.TeamFootballer", b =>
                {
                    b.HasOne("Footballers.Data.Models.Coach", "Footballer")
                        .WithMany()
                        .HasForeignKey("FootballerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Footballers.Data.Models.Footballer", null)
                        .WithMany("TeamsFootballers")
                        .HasForeignKey("FootballerId1");
