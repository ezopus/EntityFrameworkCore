        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FootballerId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamsFootballers", x => new { x.TeamId, x.FootballerId });
                    table.ForeignKey(
                        name: "FK_TeamsFootballers_Coaches_FootballerId",
                        column: x => x.FootballerId,
                        principalTable: "Coaches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamsFootballers_Footballers_FootballerId1",
                        column: x => x.FootballerId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamsFootballers_FootballerId1",
                table: "TeamsFootballers",
                column: "FootballerId1");
        }
