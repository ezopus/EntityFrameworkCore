...
namespace TravelAgency.Data
{
    ...
    {
        private const string connectionString = @"Server=.;Database=TravelAgencyExam;Integrated Security=True;Encrypt=False";
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                e.HasKey(pk => new { pk.GuideId, pk.TourPackageId });
            });
